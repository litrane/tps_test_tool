module github.com/blockchain-tps-test/samples/theta

go 1.17

replace github.com/thetatoken/theta v0.0.0 => ../../../thetatoken/theta

replace github.com/thetatoken/theta/common v0.0.0 => ../../../thetatoken/theta/common

replace github.com/thetatoken/theta/rpc/lib/rpc-codec/jsonrpc2 v0.0.0 => ../../../thetatoken/theta/rpc/lib/rpc-codec/jsonrpc2/
...
require (
	...
	github.com/herumi/bls-eth-go-binary v0.0.0-20200107021104-147ed25f233e // indirect
	...
	github.com/thetatoken/theta/rpc/lib/rpc-codec/jsonrpc2 v0.0.0 // indirect
